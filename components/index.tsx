      ...
      >
        <Text
          style={{
            ...
            color: POD(props.color, Theme.foregroundOnColoredViews),
      ...
      <TextInput
        ...
        style={{
          ...
          backgroundColor: POD(
            ...
            colors[appearance].viewBackground
          ),
    ...
    >
      <View style={{}}>
        <Text
          style={{
            fontFamily: Theme.fonts.Nunito_600SemiBold,
            color: POD(props.valueColor, colors[appearance].text),
      ...
      >
        ...
        <Text
          style={{
            ...
            color: POD(props.color, Theme.primary),
            fontSize: props.fontSize ? props.fontSize : windowWidth / 30,
            textAlign: "left",
          }}
        >
